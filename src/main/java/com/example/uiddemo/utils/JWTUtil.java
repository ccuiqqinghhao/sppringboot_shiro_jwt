...
public class JWTUtil {
    ...
    private static final String defaultbase64ENcodedSecretKey = "youqian";
    ...
    public String encode(String iss, long ttlMillis, Map<String, Object> claims) {
        ...
        JwtBuilder jwtBuilder = Jwts.builder()
                .setClaims(claims)
                .setId(iss)//这个是JWT的唯一标识，一般设置成唯一的，这个方法可以生成唯一标识
        ...
        if(ttlMillis > 0) {
            ...
            Date exp = new Date(expMillis);// 过期时间，这个也是使用毫秒生成的，使用当前时间+前面传入的持续时间生成
    ...
    *//**
     ...
     * @return 加密的token
     *//*
    public static JWTToken sign(String userID, String password) {
        // 捕获异常有错, 故不捕获
        *//*try {
